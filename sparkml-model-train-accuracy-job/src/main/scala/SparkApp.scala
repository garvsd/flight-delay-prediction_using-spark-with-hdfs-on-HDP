...
object SparkApp extends App {
  ...
  /* val dataPath = getClass.getResource("flights_jan_2014.csv").getPath */
  val rdd = sc.textFile("/user/root/demodata/flights_jan_2014.csv")
  ...
  model.save(sc,"/user/root/demodata/prediction/model")
